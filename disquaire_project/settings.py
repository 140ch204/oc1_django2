...
SECRET_KEY = os.environ.get('SECRET_KEY', 'Q;:LkB{no$xz3YKZ}y*\rMlJ4') # development key for the moment
...
DATABASES = {
    'default': {
        ...
        'USER': 'besombes', # attention : remplacez par votre nom d'utilisateur
        'PASSWORD': '',  # aa0307pave
        'HOST': '',
        'PORT': '5432',
    }
